...
```bash
git clone https://github.com/qiuqiu19950918-hue/project-memory-skills.git
cp -r project-memory-skills/project-memory-compact/.agents/* /path/to/your-project/
```

> ⚠️ 与 [project-memory](../project-memory) **不能同时安装**。先删旧变体再装新的。
